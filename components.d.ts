...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    DemoAlertColoredBorder: typeof import('./src/components/alert/DemoAlertColoredBorder.vue')['default']
    DemoAlertColors: typeof import('./src/components/alert/DemoAlertColors.vue')['default']
    DemoAlertDensity: typeof import('./src/components/alert/DemoAlertDensity.vue')['default']
    DemoAlertElevation: typeof import('./src/components/alert/DemoAlertElevation.vue')['default']
    DemoAlertIcons: typeof import('./src/components/alert/DemoAlertIcons.vue')['default']
    DemoAlertOutlined: typeof import('./src/components/alert/DemoAlertOutlined.vue')['default']
    DemoAlertProminent: typeof import('./src/components/alert/DemoAlertProminent.vue')['default']
    DemoAlertTonal: typeof import('./src/components/alert/DemoAlertTonal.vue')['default']
    DemoAlertType: typeof import('./src/components/alert/DemoAlertType.vue')['default']
    DemoAlertVModelSupport: typeof import('./src/components/alert/DemoAlertVModelSupport.vue')['default']
